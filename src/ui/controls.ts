...
export const SHORTCUTS: Control[] = [
  ...
  { group: 'Units', keys: 'Shift+W', does: 'Dig ditches all the way to a tile you click next' },
  { group: 'Units', keys: 'Shift+A', does: 'Auto work: a worker finds land to improve by itself' },
